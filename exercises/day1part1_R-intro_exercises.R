...
data <- read_csv("data/gapminder5.csv")
...
gapminder07$lifeExp_highlow[mean(gapminder07$lifeExp) > gapminder07$lifeExp] <- "High"
gapminder07$lifeExp_highlow[mean(gapminder07$lifeExp) < gapminder07$lifeExp] <- "Low"
...
avg_lifeExp <- aggregate(mean(gapminder07$lifeExp))
...
hist(gapminder07$lifeExp, main = "Test histogram", axes = TRUE, xlab = "Life expectancy", ylab = "Frequency")
